...
do
    ...
    $OBJDUMP --dwarf=decodedline $file |& tail -n+3 > dwarf-decodedline.${f}.txt
    ...
    $OBJDUMP --dwarf=str $file |& tail -n+3 > dwarf-str.${f}.txt
    $OBJDUMP --dwarf=loc $file |& tail -n+3 > dwarf-loc.${f}.txt
    # $OBJDUMP --dwarf=Ranges $file |& tail -n+3 > dwarf-Ranges.${f}.txt
    ...
    # $OBJDUMP --dwarf=links $file |& tail -n+3 > dwarf-links.${f}.txt
    # $OBJDUMP --dwarf=follow-links $file |& tail -n+3 > dwarf-follow-links.${f}.txt
    cd - >/dev/null
done
